...
public class LineBot extends OpMode {
    ...
    public void loop() {
        ...
        double targetangle = getTargetAngle(this.targetLocation.pos);
        telemetry.addData("Target Angle: ", targetangle);
        double distance = pointDistance(this.gyroEncoderLocation.pos,this.targetLocation.pos);
